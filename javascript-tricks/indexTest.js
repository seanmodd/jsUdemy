...
var newArr = Object.keys(obj).length
console.log(newArr)
...
var newPerson = Object.entries(person)
...
//first approach is Object.assign
...
//first approach is Object.keys then .map
var values = Object.keys(user).map((key) => user[key]);
console.log(values);
//second approach is Object.keys 
...
//fourth approach is spread to push
...
//first approach is Math.round to Math.random on the ages.length
...
//second approach is split





//third approach is filter
//third approach is with filter method, however filter does not modify the original array unless you run map and splice with return...
var ints = [4, 5, 6];
